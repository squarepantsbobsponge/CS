...
void ProgramManager::schedule()
{
    ...
    {
        // 回收线程，子进程留到父进程回收//子进程exit在调度前已经释放掉了自己的页目录表
