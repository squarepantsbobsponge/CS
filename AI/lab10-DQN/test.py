# # sample=[(1,11,111,1111),(2,22,222,2222),(3,33,333,3333)]
# # list1,list2,list3,list4=zip(*sample)
# # print(list1)
# # print(list2)
# # print(list3)
# # import gym
...
#         # YOUR CODE HERE #
#         self.hide=nn.Linear(4,60) #有四个状态值
#         self.relu=nn.ReLU()
#         self.out=nn.Linear(60,2)  #有两个动作（0，1）
...
# # print(max_index)
# seleted_output=output.detach().numpy()
# print(seleted_output)
